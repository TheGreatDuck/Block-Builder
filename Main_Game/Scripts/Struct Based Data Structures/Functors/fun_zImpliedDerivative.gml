//fun_yImpliedDerivative(f, appendix)
...
switch(fun_getType(argument[0]))
{
    ...
    case 7: //fun_mult
        ...
        break
    case 8: //fun_div
        return fun_div(fun_subt(fun_mult(y,fun_xImpliedDerivative(argument[2],argument[1])),fun_mult(argument[2],fun_xImpliedDerivative(argument[3],argument[1]))),fun_mult(argument[3],argument[3]));
        break
    case 9: //fun_sin
        return fun_cos(fun_xImpliedDerivative(argument[2],argument[1]));
        break
    case 10: //fun_cos
        return fun_mult(fun_const(-1),fun_sin(fun_xImpliedDerivative(argument[2],argument[1])));
        break
    case 11: //fun_floor
