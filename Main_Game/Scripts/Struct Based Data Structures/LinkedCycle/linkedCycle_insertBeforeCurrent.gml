...
} else
{
    ...
    argument[4] = node_getPrevious(argument[3]);
    node_setPrevious(argument[3], argument[2]);
    node_setNext(argument[4],argument[2]);
    node_setNext(argument[2], argument[3]);
    node_setPrevious(argument[2],argument[4]);
}
